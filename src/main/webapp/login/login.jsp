        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><%--<strong>CMFZ</strong>--%> 持明法州登陆系统</h1>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 286px;padding-left:20px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       type="test" name="inputCode"  placeholder="请输入验证码... " id="form-code" required>
                            </div>
